...
1. Установить Inno Setup (https://www.jrsoftware.org/isdl.php).

2. Скрипт setup.iss предназначен для создания инсталлятора. При изменении версии проекта,
необходимо изменить значение переменной MyAppVersion в файле setup.iss.

3. В файле setup.bat задать переменной PATH путь к папке с установленной программой Inno Setup.

4. Для создания инсталлятора необходимо из корневой папки проекта выполнить команду:
