...
1. Загрузка датасетов в формате zip (https://tracker.yandex.ru/ECS-82)
2. Обновление интерфейса с использованием темы flatlaf look and feel (https://tracker.yandex.ru/ECS-75)
3. Добавление файла jvm.options с конфигурацией jvm (https://tracker.yandex.ru/ECS-76)
4. Построение нескольких моделей одновременно (https://tracker.yandex.ru/ECS-77)
5. Оптимизация работы с большими таблицами датасетов (https://tracker.yandex.ru/ECS-78). Добавлена пагинация, уменьшено потребление RAM для таблиц с датасетами, оптимизация времени выполнения основных операций над таблицами.
6. Поддежка персональных токенов доступа, для интеграции с eca-service (https://tracker.yandex.ru/ECS-79)